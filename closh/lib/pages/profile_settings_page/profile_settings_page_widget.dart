...
class _ProfileSettingsPageWidgetState extends State<ProfileSettingsPageWidget> {
  ...
  void initState() {
    ...
    _model.provinceController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.province, ''));
    _model.provinceFocusNode ??= FocusNode();

    _model.fullAdrressController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.fullAddress, ''));
    _model.fullAdrressFocusNode ??= FocusNode();
  }
              ...
              Padding(
                ...
                child: AuthUserStreamWidget(
                  builder: (context) => TextFormField(
                    ...
                    style: FlutterFlowTheme.of(context).bodyMedium,
                    validator:
                        _model.provinceControllerValidator.asValidator(context),
                  ),
                ),
              ),
              Padding(
                ...
                child: AuthUserStreamWidget(
                  builder: (context) => TextFormField(
                    controller: _model.fullAdrressController,
                    focusNode: _model.fullAdrressFocusNode,
                    textCapitalization: TextCapitalization.words,
                    obscureText: false,
                    decoration: InputDecoration(
                    ...
                    maxLines: 3,
                    validator: _model.fullAdrressControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await currentUserReference!.update(createUsersRecordData(
                        ...
                        fullAddress: _model.fullAdrressController.text,
